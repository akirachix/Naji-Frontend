...
const kenyanCounties = ['Kiambu', 'Kericho','Kisii','Bomet','Nakuru', 'Migori', 'Nyeri', 'Kajiado','Narok',];
...
const FarmerRegistrationForm = () => {
  ...
  const handleNameChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    setValue('farmer_name', capitalized); 
  };
  ...
  return (
    <div className="flex justify-center items-start min-h-2.5">
      <div className="w-full max-w-md md:max-w-2xl lg:max-w-3xl xl:max-w-4xl 2xl:max-w-5xl h-auto p-4 lg:p-2 rounded-lg flex flex-col justify-start 2xl:mt-32 lg:mt-1">
        <h2 className="text-2xl md:text-3xl lg:mt-1 xl:mt-10 lg:text-4xl font-bold mb-4 md:mb-8 text-center text-[#3D0F00]" style={{ fontFamily: 'serif' }}>
          Register Farmer
        </h2>
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 md:space-y-8">
            ...
            <input
              ...
              {...register('farmer_name', {
                ...
                pattern: {
                  ...
                  message: 'Name must contain two words, both starting with capital letters',
                },
                validate: {
                  twoWords: value => value.split(' ').length === 2 || 'Name must contain exactly two words',
                }
              })}
              ...
              onChange={handleNameChange} // Add the name change handler here
            />
            {errors.farmer_name && <p className="text-red-600 text-sm">{errors.farmer_name.message as string}</p>}
          </div>
          ...
          <div className="mb-4 md:mb-8">
            ...
            <input
              ...
              style={{ fontFamily: 'serif' }}
            />
            {errors.farmer_phone_number && <p className="text-red-600 text-sm">{errors.farmer_phone_number.message as string}</p>}
          </div>
          ...
          <div className="mb-4 md:mb-8">
            ...
            {errors.farmer_county && <p className="text-red-600 text-sm">{errors.farmer_county.message as string}</p>}
          </div>
